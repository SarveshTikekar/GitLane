  ...
  Future<void> _openResolver(String fileName) async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text("Resolve: $fileName", style: const TextStyle(color: AppTheme.accentCyan, fontSize: 16)),
        content: SizedBox(
          width: double.maxFinite,
          child: TextField(
            controller: controller,
            maxLines: 20,
            style: const TextStyle(color: AppTheme.textLight, fontSize: 12, fontFamily: 'monospace'),
